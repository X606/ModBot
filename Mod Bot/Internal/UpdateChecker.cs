...
namespace InternalModBot
{
	...
	internal class UpdateChecker : MonoBehaviour
	{
		...
		IEnumerator checkVersion()
		{
			...
			SimpleMessageBox updateAvailableMessage = new SimpleMessageBox(message);
			updateAvailableMessage.AddButton(new MessageBoxButton(dismissButtonText, Color.red));
			updateAvailableMessage.AddButton(new MessageBoxButton(installButtonText, Color.green, onInstallButtonClicked));
			updateAvailableMessage.DisplayMessageNow();
		}
