...
{
    public class AccessorInstanceSetPrivatePropertyUnitTest : UnitTest
    {
        AccessorTestFields _accessorTestFieldsInstance;

        public override string CommandActivator => "AccessorInstanceSetPrivateProperty";
        ...
        public override object[] RunTest()
        {
            ...
            accessor.SetPrivateProperty("FloatingPointValueProperty", (object)2f);
            accessor.SetPrivateProperty("StringValueProperty", (object)"TestValue2");
