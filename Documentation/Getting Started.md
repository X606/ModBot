...
2\. [Unity 6000.3.14f1](https://unity3d.com/get-unity/download/archive)
...
NOTE: It needs to be the exact version of Unity that Clone Drone uses (6000.3.14f1) or the game will crash when trying to import the custom assets.
